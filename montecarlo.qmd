# Capítulo 4: Simulación Computacional y Análisis de Resultados
...
### Perturbaciones Discretas: Apertura de Puertas ($N_{puerta}(t)$) {#sec-aperturas-puerta}
...
Para la duración de estos cortes, utilizamos una distribución Log-Normal calibrada por el método de los momentos en la @sec-lognormal-duracion para las distintas épocas del año: temporada base ($\mu = 0.6766, \sigma = 0.6202$), temporada de calor ($\mu = 0.9627, \sigma = 0.5106$) y temporada de lluvias ($\mu = 0.4668, \sigma = 0.3372$).
